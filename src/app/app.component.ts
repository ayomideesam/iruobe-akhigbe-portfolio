...
@Component({
    ...
    <div class="app-container" [ngClass]="{'dark-theme': isDarkTheme}">
      ...
      <div class="floating-letters-container">
        <div *ngFor="let letter of floatingLetters; trackBy: trackByFn"
          [ngStyle]="{
      ...
      <div class="loading-overlay" [class.active]="!isLoadingComplete" [@overlayAnimation]>
        ...
        <div class="welcome-message-container" *ngIf="!hasExploded" [@welcomeAnimation]>
      ...
      <!-- Main Content -->
      <app-header *ngIf="isLoadingComplete"></app-header>
      <main [@mainContentAnimation]="isLoadingComplete ? 'visible' : 'hidden'">
        <router-outlet></router-outlet>
      </main>
      <a href="https://wa.me/2347038772342" *ngIf="isLoadingComplete"
        target="_blank" 
      ...
      <app-footer *ngIf="isLoadingComplete"></app-footer>
    </div>
  `,
    styles: [`
    :host {
