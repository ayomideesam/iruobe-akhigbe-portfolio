...
export class ResumeComponent extends SubscriptionManagementDirective implements OnInit {
  ...
  //     // Hide download button in references section
  ...
  //     // Set up canvas options with proper scaling and dimensions
  ...
  //           }
  //           .resume-left {
  //             background-color: ${this.isDarkTheme ? '#1E1E1E' : '#F4F4F4'} !important;
  //             padding: 1.75rem;
  //           }
  //           .resume-right {
  //             background-color: ${this.isDarkTheme ? '#121212' : '#FFFFFF'} !important;
  //             padding: 2rem 3rem;
  //           }
  //           .download-pdf {
  ...
  //     const pdf = new jsPDF('p', 'pt', [imgWidth, Math.max(pageHeight, imgHeight)]);
  //     let position = 0;
